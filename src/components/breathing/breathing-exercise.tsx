  ...
  return (
    <div className="flex flex-col items-center gap-8 py-8">
      ...
      <div className="relative w-48 h-48 flex items-center justify-center">
        <div 
          className="absolute w-full h-full bg-primary/20 rounded-full transition-transform duration-1000"
          style={animationStyle}
        ></div>
        <div 
          className="absolute w-full h-full bg-primary/30 rounded-full transition-transform duration-1000"
