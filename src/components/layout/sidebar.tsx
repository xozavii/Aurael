...
const navItems = [
  ...
  { href: '/breathing', icon: AuraelWaveIcon, label: 'Meditation' },
    ...
    <Sidebar className="border-r border-white/10 bg-card/30 backdrop-blur-xl" collapsible="icon">
        <SidebarHeader className="p-4">
            <Link href="/" className="flex items-center gap-2 group-data-[collapsible=icon]:justify-center">
                <AuraelWaveIcon className="w-8 h-8 text-primary group-data-[collapsible=icon]:w-6 group-data-[collapsible=icon]:h-6 transition-all" />
