...
export default function MeditationPage() {
    ...
    return (
        <div className="container mx-auto max-w-5xl">
             <Card className="w-full bg-card/60 backdrop-blur-lg border-white/20 with-left-shadow mb-8">
                <CardHeader>
                    ...
                    <CardDescription>
                        Find your inner peace with our collection of guided meditations, or create your own with AI.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                        ...
                        <CardHeader className="relative z-10">
                             <div className="flex items-center justify-between">
                                <div className="p-3 bg-primary/20 rounded-full mb-3">
                                    <meditation.icon className="w-7 h-7 text-primary" />
                                </div>
