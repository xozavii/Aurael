...
const dashboardItems = [
  ...
  { href: '/breathing', icon: LotusIcon, label: 'Breathing', description: "Find calm with guided exercises." },
  { href: '/meditation', icon: Sparkles, label: 'Meditation', description: 'Listen to guided meditations.' },
